...
class Report_sqm_viento extends MY_Controller
{
    ...
    function index()
    {
        ...
        $view_data["iframe_src"] = "https://marcelooyaneder-wind-barbs-sqm.hf.space";

        $this->template->rander("report_sqm_viento/index", $view_data);
    }
}
