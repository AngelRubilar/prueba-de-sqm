...
class Report_auto extends MY_Controller
{
    ...
    function index()
    {
        ...
        $view_data["iframe_src"] = "https://particulas.shinyapps.io/sqm_report_gen/";

        $this->template->rander("report_auto/index", $view_data);
    }
}
