...
class Report_sqm_pm10 extends MY_Controller
{
	...
	function index()
	{
		...
		//https://sqm.mimasoft.cl/react
		if($id_client_group==6){
       		$view_data["iframe_src"] = "http://localhost:3000/react/pm10";
			$this->template->rander("report_sqm_pm10/index", $view_data);
		} else if($id_client_group==7){
			$view_data["iframe_src"] = "http://localhost:3000/react/pm10-grup1";
			$this->template->rander("report_sqm_pm10/index", $view_data);
		} else {
			$view_data["iframe_src"] = "http://localhost:3000/react/pm10-grup2";
			$this->template->rander("report_sqm_pm10/index", $view_data);
		}
