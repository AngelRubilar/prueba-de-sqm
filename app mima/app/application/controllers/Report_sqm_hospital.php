...
class Report_sqm_hospital extends MY_Controller
{
	...
	function index()
	{
        ...
        $view_data["iframe_src"] = "http://localhost:3000/react/hospital";
		$this->template->rander("report_sqm_hospital/index", $view_data);
