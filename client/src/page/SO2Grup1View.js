      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Dashboard SO₂ - Superintendencia Operaciones Medio Ambiente Nueva Victoria
          </h1>
          <div style={{
            display: 'flex',
            alignItems: 'center',
